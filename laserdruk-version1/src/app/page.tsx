import heroImage from "../../public/Frame6.jpg";

export default function Home() {
	return (
		<div className="max-w-[1200px] m-auto">
			<nav className="mt-8 w-full bg-neutral-900 text-slate-50 flex justify-between items-center rounded-xl drop-shadow-md">
            ...
            <h1 className="font-display uppercase text-7xl text-slate-50 text-right pt-4 pr-3">Co drukujemy,<br/> mordziaty?</h1>
          </div>
					...
					<div className="col-start-4 col-end-5 row-start-7 row-end-9 bg-orange-500 rounded-xl flex justify-center items-center drop-shadow-md hover:cursor-pointer">
						<p className="font-medium text-white uppercase">Skontaktuj się z nami</p>
					</div>
				</section>
			</main>
		</div>
